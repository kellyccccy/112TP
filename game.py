...
class Boss(GameObject):
    ...
    def enlarge(self):
        self.width += 1
        self.height += 1
        self.image = pygame.transform.scale(Boss.image, (self.width, self.height))
    ...
    def updateOriginalImage(self):
        self.originalImage = pygame.transform.scale(Boss.image, (self.width, self.height))
